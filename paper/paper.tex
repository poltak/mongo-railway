...
The dataset received from the IRT team has the layout as shown in~\tabref{tab:irt_data}. It consists of 99999 data points
...
\hline
\textbf{Data name}      & \textbf{Possible values}               & \textbf{Meaning} \\ \hline
\textbf{Time}           & Floating point value                   & Time in milliseconds since... \\ \hline
\textbf{Speed}          & Floating point value                   & Speed in km/h (?)  \\ \hline
\textbf{LoadEmpty}      & -1, 0                                  & Boolean flag denoting whether or not load is present in train cars.  \\ \hline
\textbf{km}             & Floating point value                   & Amount of kilometres travelled since...  \\ \hline
...
\textbf{Track}          & Integer value from 1 to 213841         & Given track in which the train is located.   \\ \hline
\textbf{SND1}           & Floating point value                   & ?  \\ \hline
\textbf{SND2}           & Floating point value                   & ?  \\ \hline
\textbf{SND3}           & Floating point value                   & ?  \\ \hline
\textbf{SND4}           & Floating point value                   & ?  \\ \hline
