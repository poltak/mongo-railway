...
MongoDB also allows for common database operations, such as indexing, replication, and sharding. Mongo's indexing system
supports multiple types of indexes, including single key, multi-key, geospatial, and hashed indexes. Indexes are stored
internally using a B-Tree data structure

In terms of joins, MongoDB,
